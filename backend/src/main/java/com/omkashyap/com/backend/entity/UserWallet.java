...
@Table(name = "user_wallet", uniqueConstraints = {
        @UniqueConstraint(name = "uk_user_wallet_wallet_id", columnNames = "wallet_id"),
        @UniqueConstraint(name = "uk_user_wallet", columnNames = { "wallet_id", "user_id" })
})
