      ...
      <main className="container mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <Card className="overflow-hidden">
          <CardHeader className="relative">
            <div className="flex items-start gap-4">
              <div className="flex size-14 shrink-0 items-center justify-center rounded-xl border bg-primary/5 backdrop-blur-sm">
          ...
          <CardContent className="relative pt-0">
            <div className="mt-2 flex flex-wrap items-center justify-between gap-x-4 gap-y-2 text-sm text-muted-foreground">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                <Badge className="shadow">{category}</Badge>
              ...
              <span suppressHydrationWarning>
                Join at: {format(new Date(createdAt as string), "PPP")}
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <section className="mt-8">
          <div className="mb-5 flex items-end justify-between gap-4">
            <div>
              <Heading2>Explore products from {shopName}</Heading2>
            </div>
